...
document.addEventListener('DOMContentLoaded', () => {
    ...
    domController.elements.projectForm.addEventListener('submit', (e) => {
        ...
        if (projectData) {
            let result;
            let action = 'added';
            if (projectData.id) { // Editing an existing project
    ...
    domController.elements.projectListUL.addEventListener('click', (e) => {
        ...
        if (e.target.classList.contains('edit-project-btn')) {
            ...
            if (projectToDelete && confirm(`You will permanently delete project: "${projectToDelete.name}" and all its taks!!`)) {
        ...
        } else if (e.target.closest('.project-name') || e.target === projectLi){ // User clicked on a name or li itself
    ...
    domController.elements.addTodoBtn.addEventListener('click', () => {
        ...
        if (currentProject) {
            ...
            domController.showNotification('Please select a project to add task.', 'warning');
        }
    });
